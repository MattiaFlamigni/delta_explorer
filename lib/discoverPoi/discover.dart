import 'package:delta_explorer/discoverPoi/discover_controller.dart';
...
class _DiscoverState extends State<Discover> {
    ...
    return Scaffold(
      ...
      body:
          _isLoading
              ...
              ? showEmpty()
              : RefreshIndicator(
                // Permette all'utente di ricaricare la lista  scorrendo verso il basso
  ...
  Widget showNearPOI() {
    return ListView.separated(
      ...
      // Separatore visivo tra gli elementi
      padding: const EdgeInsets.all(8.0),
      itemBuilder: (BuildContext context, int index) {
        final poi = controller.getNearPoiList()[index];
        final String title = poi['title'] ?? 'Nome non disponibile';
        final String description =
            poi['description'] ?? 'Nessuna descrizione disponibile';
        final String? imageUrl =
            poi['image_url']; // Assumi che ci sia un URL dell'immagine

        return InkWell(
          // Rende l'elemento tappabile
          onTap: () {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            SizedBox(width: 80, height: 80, child: showImage(imageUrl)),
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                poi['title'] ?? 'Nome non disponibile',
                style: const TextStyle(
                  fontSize: 24,
                  fontWeight: FontWeight.bold,
                  color: Colors.green,
