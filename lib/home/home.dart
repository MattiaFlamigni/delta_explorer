        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: drawInfoSection(Icons.place_rounded, "Indirizzo","Provincia di Ferrara"),
            ),
            Padding(
              padding: EdgeInsets.symmetric(vertical: 10, horizontal: 15),
              // Aggiunta una spaziatura più bilanciata
              child: drawInfoSection(Icons.access_time_rounded, "Orari","24 ore su 24"),
            ),
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            color:
            Colors
                .black54, // Colore grigio per il testo secondario
          ),
        ),
      ],
    );
